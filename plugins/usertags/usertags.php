...
Description: Enables posts to be "tagged" with registered users of the site enabling WordPress to have multiple users/authors associated with a single post
Version: 0.1
...
class User_Tags{
	...
	function save_user_tags($post_id){
	    ...
	    if ( !wp_verify_nonce( $_POST["user_tags_nonce"], get_current_theme() ) ){
	        return;
	    }
